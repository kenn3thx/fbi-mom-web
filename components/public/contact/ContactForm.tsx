...
export default function ContactForm() {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            {/* Email */}
            <div>
                <label className="font-bold">Email Address <span className='text-rose-500'>*</span></label>
                <input
                    type="email"
            ...
            {/* Title */}
            <div>
                <label className="font-bold">What can we help you with? <span className='text-rose-500'>*</span></label>
                <input
                    type="text"
                    className="form-input"
                    value={form.title}
            ...
            {/* Description */}
            <div>
                <label className="font-bold">Your Message <span className='text-rose-500'>*</span></label>
                <textarea
                    rows={6}
                    className="form-input"
